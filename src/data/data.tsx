...
export const EXPERIENCE: TimelineProps[] = [
  ...
  },
  {
    ...
    tech: ["VB.net", "Sql Server","Server Windows","Gestion de projet agile (avec Jira)"],
  },
  {
    key: 4,
    ...
    description: " Application d'amelioration de la traçabilité process des carte electronique d'Arium Consulting: develeppement et Etude fonctionnel (etude de l'existant, analyse du besoins, rédaction du cahier des charges à destination de la maîtrise d’oeuvre. La conception et la réalisation de la solution qui répond aux besoins",
    tech: ["C#", "Sql Server","Gestion de projet agile (avec Jira)"],
  },
  {
    key: 5,
