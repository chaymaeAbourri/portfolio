...
export const EXPERIENCE: TimelineProps[] = [
  {
    key: 1,
    company: "Chef de projet Gestion des devis préalables en Symfony et en interaction avec l'Erp Sage",
    position: "",
    ...
    tech: ["Symfoy","Javascript", "UML", "Sage", "Scrum","Trello"],
  },
  {
    key: 2,
    company: "Chef de projet d'application de gestion des interventions en interaction avec Sage",
    position: "",
    logo: "https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png",
    start: "2022",
    end: "2023",
    ...
    tech: ["VB.net", "UML","ERP Sage","Scrum","Trello"],
  },
  {
    key: 3,
  ...
  {
    key: 4,
    company: "CONSULTANTE ET DÉVELOPPEUSE CHEZ ARIUM CONSULTING",
    position: "",
    logo: "https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png",
    start: "2020",
    end: "2021",
  ...
  },
  {
    ...
    tech: ["C#", "Sql Server","ERP MFG Pro","GP Agile"],
  },
  {
    key: 6,
