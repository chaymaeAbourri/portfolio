...
export const EXPERIENCE: TimelineProps[] = [
  {
    ...
    tech: ["VB.net", "SqlServer", "UML","ERP Sage", "Gestion de projet agile (avec Jira)"],
  },
  {
    key: 2,
    position: "Chef de projet web",
  ...
  },
  {
    ...
    tech: ["VB.net", "Sql Server","Server Windows","ERP Sage","Gestion de projet agile (avec Jira)"],
  },
  {
    key: 5,
    ...
    tech: ["C#", "Sql Server","ERP MFG Pro","Gestion de projet agile (avec Jira)"],
  },
  {
    key: 6,
